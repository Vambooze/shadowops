...
Config.RemoveChance = 45					-- 0-100% Chance to remove the item on use
...
Config.LEOJobName = {'police','lcso'} 		-- Job name of law enforcement officers (NOW TYPE)
...
Config.VINCheck = true						-- If true, allows LEOs to check if vehicles have been scratched.
...
Config.TimetoRoute = 5 						-- How long in minutes, until the drop off point is shown.
