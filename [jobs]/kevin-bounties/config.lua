...
Config.DeskPedLocation = vector4(8.77, -243.17, 55.86, 166.38) -- Location of start ped
...
Config.Locations = {
    [1] = { -- Davis Ave Area
        ...
        BountyPay = math.random(450, 800) -- self explanatory
    },
    [2] = { -- Vinewood Area
        SpawnGoons = 'true',
...
Config.GoonHealth = 200
Config.GoonArmor = 100
Config.GoonWeapon = `WEAPON_PISTOL`
Config.GoonAccuracy = 90
