...
RegisterNetEvent('jim-recycle:Trade:Menu', function()
	...
	if amount >= 5000 then tradeMenu[#tradeMenu+1] = { icon = "recyclablematerial", header = Loc[Config.Lan].menu["trade5000"], params = { event = "jim-recycle:SellAnim", args = 5 } } end
	if amount >= 10000 then tradeMenu[#tradeMenu+1] = { icon = "recyclablematerial", header = Loc[Config.Lan].menu["trade10000"], params = { event = "jim-recycle:SellAnim", args = 6 } } end
