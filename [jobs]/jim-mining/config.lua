...
Config = {
	...
	Job = false, -- set this to a job role eg "miner" or nil for no job
	Notify = "qb",
	K4MB1 = false,
	K4MB1Only = false,
	...
	Timings = { -- Time it takes to do things
		["Cracking"] = math.random(4000, 8000),
		["Washing"] = math.random(6000, 8000),
		["Panning"] = math.random(12000, 15000),
		["Pickaxe"] = math.random(8000, 10000),
		["Mining"] = math.random(3000, 4000),
		["Laser"] = math.random(1000, 2000),
	...
	Locations =  {
		['MineStore'] = {
			...
			{ name = "Foundary Store", coords = vector4(737.95, -1080.3, 22.17, 97.29), sprite = 436, col = 1, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
		},
		['Smelter'] = {	 -- The location of the smelter
			{ name = "Foundary", coords = vector3(726.27, -1067.2, 28.31), sprite = 436, col = 1, blipTrue = false, },
		},
		["Washing"] = {
...
--			{ name = "Gold Panning", coords = vector3(-1551.31, 1444.15, 116.44), sprite = 467, col = 5, disp = 6, blipTrue = true }, -- Tongva
		...
		['Cracking'] = { -- The location of the smelter
			{ name = "Stone Cracking", coords = vector4(726.24, -1066.46, 28.31, 178.87), sprite = 566, col = 81, blipTrue = false, prop = `prop_planer_01` }, -- Foundary
			
		},
		['OreBuyer'] = { -- The Locations of the ore buyers
			{ name = "Ore Buyer", coords = vector4(732.44, -1072.57, 28.19, 144.9), sprite = 568, col = 81, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
		['JewelCut'] = { -- The Location of the jewel cutting bench. Couldn't decide so left in smeltery
			{ name = "Jewel Cutting", coords = vector4(724.88, -1074.52, 28.31, 284.27), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` },
			{ name = "Jewel Cutting", coords = vector4(724.83, -1073.31, 28.31, 279.52), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` },
		},
		['JewelBuyer'] = { -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
			{ name = "Jewel Buyer", coords = vector4(151.68, -1050.39, 29.23, 256.62), sprite = 527, col = 617, blipTrue = false, model = `S_M_M_HighSec_03`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
	},
...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['ruby_ring'] = 500,
		['sapphire_ring'] = 1000,
		['diamond_ring_silver'] = 1500,
		['emerald_ring_silver'] = 1000,
		['ruby_ring_silver'] = 1000,
		['sapphire_ring_silver'] = 2000,
		['uranium'] = 3000,
		...
		['ruby_necklace_silver'] = 400,
		['sapphire_necklace_silver'] = 600,

		['diamond_earring'] = 100,
		['emerald_earring'] = 200,
		['ruby_earring'] = 250,
		['sapphire_earring'] = 500,
		['diamond_earring_silver'] = 300,
		['emerald_earring_silver'] = 400,
		['ruby_earring_silver'] = 450,
		['sapphire_earring_silver'] = 550,
...
--Mining Store Items
	Items = {
		...
		items = {
			...
			{ name = "sandwich", price = 20, amount = 250, info = {}, type = "item", slot = 2, },
			{ name = "bandage", price = 100, amount = 100, info = {}, type = "item", slot = 3, },
			{ name = "weapon_flashlight", price = 0, amount = 100, info = {}, type = "item", slot = 4, },
			{ name = "goldpan", price = 7500, amount = 100, info = {}, type = "item", slot = 5, },
			{ name = "pickaxe",	price = 100, amount = 100, info = {}, type = "item", slot = 6, },
			{ name = "miningdrill",	price = 50000, amount = 50, info = {}, type = "item", slot = 7, },
			{ name = "mininglaser",	price = 150000, amount = 5, info = {}, type = "item", slot = 8, },
			{ name = "drillbit", price = 150, amount = 100, info = {}, type = "item", slot = 9, },
		},
	},
}
Crafting = {
