...
Config = {
	...
	img = "origen_inventory/html/images/", --Set this to the image directory of your inventory script or "nil" if using newer qb-menu
...
------------------------------------------------------------
	...
	SellingPrices = { -- Selling Prices
		...
		['diamond_earring_silver'] = 375,
		['emerald_earring_silver'] = 375,
