...
-- Player vehicle repair config
	ManualRepairCost = 10000, -- Set this to a high amount to get people to talk to mechanics rather than use automated systems
...
-- NOS STUFF
	NosRefillCharge = 100000, -- amount in dollars required to refill a nos can

	NosTopSpeed = 28.0, -- Enabling this adds a multiplier to the top speed of the vehicle
