Crafting = {
	Tools = {
		...
		{ ["newoil"] = { ["plastic"] = 150, } },
		{ ["sparkplugs"] = { ["metalscrap"] = 150, } },
		{ ["carbattery"] = { ["metalscrap"] = 150, ["plastic"] = 1 } },
		{ ["axleparts"] = { ["steel"] = 150, } },
		{ ["sparetire"] = { ["rubber"] = 150, } },
...
Stores = {
	ToolItems = {
		...
		items = {
			...
			{ name = "sparetire", price = 300, amount = 100, info = {}, type = "item", },
			{ name = "axleparts", price = 300, amount = 1000, info = {}, type = "item", },
			{ name = "carbattery", price = 300, amount = 1000, info = {}, type = "item", },
			{ name = "sparkplugs", price = 150, amount = 1000, info = {}, type = "item", },
	...
	StoreItems = {
		...
		items = {
			...
			{ name = "seat", price = 01000, amount = 50, info = {}, type = "item", },
