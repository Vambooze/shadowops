...
Config.Locations = {
	...
	{	job = "mechanic",
		...
		stash = { { coords = vector3(-224.26, -1319.97, 30.89), w = 3.6, d = 0.6, heading = 0, }, },
		store = { { coords = vector3(-232.57, -1315.35, 30.89), w = 0.85, d = 1.8, heading = 359.0, }, },
		crafting = { { coords = vector3(-242.99, -1317.05, 30.89), w = 2.8, d = 1.0, heading = 270.0, }, },
		clockin = { { coords = vector3(-195.15, -1337.09, 30.63), heading = 210.0, }, },
		garage = { spawn = vector4(-186.55, -1310.41, 31.30, 98.71),
					out = vector4(-182.81, -1316.78, 31.30, 354.88),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" } },
        payments = { coords = vector3(-203.29, -1338.40, 30.89), heading = 0.0, img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/b/be/BennysOriginalMotorWorks-GTAO-Logo.png width=150px></p>" },
...
--		blipcolor = 81,
	...
	{	job = "mechanic",
		zones = {
			vector2(1750.02, 3335.33),
			vector2(1764.52, 3305.96),
			vector2(1786.35, 3318.51),
			vector2(1770.78, 3346.18)
		},
		stash = { { coords = vector3(1764.15, 3324.13, 41.44), w = 11.6, d = 0.6, heading = 123.0 }, },
		store = { { coords = vector3(1763.61, 3331.54, 41.44), w = 14.6, d = 0.5, heading = 17.0 }, },
		crafting = { { coords = vector3(1766.97, 3324.65, 41.44), w = 3.2, d = 1.0, heading = 209.0 }, },
		clockin = { { coords = vector3(1769.44, 3322.55, 41.42), heading = 185.0, }, },
		garage = { spawn = vector4(1754.72, 3323.5, 41.21, 207.72),
					out = vector4(1760.44, 3324.21, 41.35, 298.6),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3", "flatbed4", "atow", "chr20" } },
		payments = { coords = vector3(1769.44, 3500.55, 41.42), heading = 35.0, img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png width=150px></p>" },
		blip = vector3(1770.63, 3327.56, 41.44),
		bliplabel = "Flywheels Mechanic Shop",
		blipcolor = 81,
		discordlink = "",
		discordcolour = 2571775,
		discordimg = "https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png",
	},
	-- Atkins Automotive Care Sandy 2 --
	{	job = "mechanic",
		zones = {
			vector2(921.02, 3596.23),
			vector2(921.96, 3622.08),
			vector2(890.16, 3622.26),
			vector2(890.07, 3598.15)
		},
		stash = { { coords = vector3(890.956421, 3601.43, 32.83), w = 2.0, d = 1.0, heading = 285.917053 }, },
		store = { { coords = vector3(893.881165, 3613.99, 32.95), w = 1.0, d = 0.5, heading = 180.122421 }, },
		crafting = { { coords = vector3(891.366150, 3606.51, 32.83), w = 2.0, d = 0.6, heading = 240.379349 }, },
		clockin = { { coords = vector3(896.882446, 3600.87, 32.83), heading = 177.395554 }, },
		garage = { spawn = vector4(907.09, 3617.90, 32.85, 174.05),
					out = vector4(901.95, 3606.85, 32.86, 280.88),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3", "flatbed4", "chr20", "construction21f150", "17silverado", "trhawk"  } },
		...
		blip = vector3(901.17, 3607.22, 32.92),
		bliplabel = "Atkins Automotive Care",
		blipcolor = 52,
		discordlink = "",
		discordcolour = 23552,
...
--	},
	...
	{	job = "illegalmechanic",
		zones = {
			vector2(44.47, -2563.51),
			vector2(63.86, -2564.19),
			vector2(64.3, -2584.34),
			vector2(41.25, -2584.43)
		},
		stash = { { coords = vector3(52.73, -2572.96, 6.26), w = 1.6, d = 0.6, heading = 352.63, }, },
		store = { { coords = vector3(53.83, -2574.09, 6.41), w = 1.6, d = 0.6, heading = 189.78, }, },
		crafting = { { coords = vector3(60.7, -2582.31, 6.26), w = 0.6, d = 3.8, heading = 180, }, },
		clockin = { { coords = vector3(55.95, -2581.38, 6.26), heading = 81.16, }, },
		garage = { spawn = vector4(62.04, -2564.86, 6.0, 173.84),
					out = vector4(49.11, -2566.55, 6.0, 354.03),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" } },
		payments = { coords = vector3(49.11, -2566.55, 6.0), heading = 285.0, img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png width=150px></p>" },
...
--		blipcolor = 81,
	...
	{   job = "mechanic",
		...
		garage = { spawn = vector4(937.02, -990.27, 38.34, 93.92),
					...
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3", "topfoil", "aflatbed", "atow"  } },
