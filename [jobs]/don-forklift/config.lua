...
Config.FuelSystem = 'ps-fuel' -- Fuel system your server is using 
...
Config.PayScales = {
	min = 150, -- Minimum payout
	max = 300, -- Maximum payout
	bonus = 150, -- Bonus payout if the pallet is below 500 health but higher than 250
	bonus2 = 250, -- Bonus payout if the pallet is below 750 health but higher than 500
	bonus3 = 500, -- Bonus payout if the pallet is below 1000 health but higher than 750
...
Config.Locations = {
	...
	[2] = {
		...
		['Pickup'] = { -- Pickup settings ~~ I wouldn't change the vehicle as the function for finding the back is only setup for the benson ~~
			...
			['Delivery'] = {
				coords = vector3(-16.58, -2663.64, 6.0),
				heading = 184.918,
			}
		},
		['Pallets'] = { -- Pallet locations
	...
	[5] = {
		['Start'] = {
			ped = `s_m_y_airworker`,
			coords = vector3(636.49, 2785.68, 42.01), -- Where the player can take orders
			heading = 209.04,
			scenario = 'PROP_HUMAN_SEAT_COMPUTER',
			chair = -470815620
		},
		['Garage'] = { -- Garage settings
			model = `forklift`,
			ped = `s_m_m_dockwork_01`,
			coords = vector3(638.97, 2771.61, 42.05),
			heading = 348,
			scenario = 'WORLD_HUMAN_AA_COFFEE',
			['Spawn'] = {
				coords = vector3(645.73, 2767.07, 42.0),
				heading = 273.79
			}
		},
		['Pickup'] = { -- Pickup settings ~~ I wouldn't change the vehicle as the function for finding the back is only setup for the benson ~~
			...
			ped = `s_m_m_security_01`,
			['Spawn'] = {
				coords = vector3(665.24, 2712.02, 40.79),
				heading = 5.9
			},
			['Delivery'] = {
				coords = vector3(641.88, 2742.9, 41.91),
				heading = 92.05
			}
		},
		['Pallets'] = { -- Pallet locations
			[1] = vector3(618.55, 2791.39, 42.19),
			[2] = vector3(582.72, 2787.89, 42.19),
			[3] = vector3(565.24, 2806.72, 42.11),
			[4] = vector3(587.14, 2784.26, 43.48),
			[5] = vector3(593.23, 2814.22, 41.92)
		},
		inUse = false, -- DO NOT TOUCH
		user = nil -- DO NOT TOUCH
	...
	[6] = {
		['Start'] = {
			ped = `s_m_y_airworker`,
			coords = vector3(1727.96, 3291.13, 41.18), -- Where the player can take orders
			heading = 193.32,
			scenario = 'PROP_HUMAN_SEAT_COMPUTER',
			chair = -470815620
		},
		['Garage'] = { -- Garage settings
			model = `forklift`,
			ped = `s_m_m_dockwork_01`,
			coords = vector3(1716.54, 3294.54, 41.19),
			heading = 198.6,
			scenario = 'WORLD_HUMAN_AA_COFFEE',
			['Spawn'] = {
				coords = vector3(1723.23, 3269.58, 41.16),
				heading = 297.03
			}
		},
		['Pickup'] = { -- Pickup settings ~~ I wouldn't change the vehicle as the function for finding the back is only setup for the benson ~~
			...
			ped = `s_m_m_security_01`,
			['Spawn'] = {
				coords = vector3(1833.74, 3243.35, 44.15),
				heading = 79.35
			},
			['Delivery'] = {
				coords = vector3(1719.28, 3245.11, 41.15),
				heading = 99.55
			}
		},
		['Pallets'] = { -- Pallet locations
			[1] = vector3(1727.76, 3321.51, 41.22),
			[2] = vector3(1716.18, 3322.02, 41.22),
			[3] = vector3(1739.37, 3311.58, 41.22),
			[4] = vector3(1692.75, 3285.23, 41.15),
			[5] = vector3(1728.56, 3297.96, 41.22)
		},
		inUse = false, -- DO NOT TOUCH
		user = nil -- DO NOT TOUCH
	},
	[7] = {
		['Start'] = {
			ped = `s_m_y_airworker`,
			coords = vector3(2339.54, 3139.32, 48.21), -- Where the player can take orders
			heading = 96.95,
			scenario = 'PROP_HUMAN_SEAT_COMPUTER',
			chair = -470815620
		},
		['Garage'] = { -- Garage settings
			model = `forklift`,
			ped = `s_m_m_dockwork_01`,
			coords = vector3(2338.06, 3131.78, 48.21),
			heading = 69.86,
			scenario = 'WORLD_HUMAN_AA_COFFEE',
			['Spawn'] = {
				coords = vector3(2353.55, 3133.31, 48.21),
				heading = 256.43
			}
		},
		['Pickup'] = { -- Pickup settings ~~ I wouldn't change the vehicle as the function for finding the back is only setup for the benson ~~
			...
			ped = `s_m_m_security_01`,
			['Spawn'] = {
				coords = vector3(2294.32, 3097.58, 47.51),
				heading = 19.55
			},
			['Delivery'] = {
				coords = vector3(2325.69, 3123.37, 48.15),
				heading = 186.33
			}
		},
		['Pallets'] = { -- Pallet locations
			[1] = vector3(2390.75, 3080.72, 48.15),
			[2] = vector3(2422.54, 3112.42, 48.16),
			[3] = vector3(2358.95, 3126.59, 48.21),
			[4] = vector3(2406.99, 3137.39, 48.21),
			[5] = vector3(2428.45, 3124.38, 48.14)
		},
		inUse = false, -- DO NOT TOUCH
		user = nil -- DO NOT TOUCH
