...
RegisterNetEvent('bailey-chickfilajob:client:EatChickenSandwich', function() -- Eat Cupcake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"eat"})
    QBCore.Functions.Progressbar('comer_cupcake', 'EATING A Chicken Sandwich...', 5000, false, true, {
...
RegisterNetEvent('bailey-chickfilajob:client:EatDeluxeChickenSandwich', function() -- Eat Cupcake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"eat"})
    QBCore.Functions.Progressbar('comer_cupcake', 'EATING A Chicken Sandwich...', 5000, false, true, {
        disableMovement = false,
...
RegisterNetEvent('bailey-chickfilajob:client:EatSpicyChickenSandwich', function() -- Eat Cupcake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"eat"})
    QBCore.Functions.Progressbar('comer_cupcake', 'EATING A Chicken Sandwich...', 5000, false, true, {
        disableMovement = false,
...
RegisterNetEvent('bailey-chickfilajob:client:EatDeluxeSpicyChickenSandwich', function() -- Eat Cupcake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"eat"})
    QBCore.Functions.Progressbar('comer_cupcake', 'EATING A Chicken Sandwich...', 5000, false, true, {
        disableMovement = false,
...
RegisterNetEvent('bailey-chickfilajob:client:EatGrilledChickenSandwich', function() -- Eat Cupcake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"eat"})
    QBCore.Functions.Progressbar('comer_cupcake', 'EATING A Chicken Sandwich...', 5000, false, true, {
        disableMovement = false,
...
RegisterNetEvent('bailey-chickfilajob:client:EatChickenStrips', function() -- Eat Cupcake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"eat"})
    QBCore.Functions.Progressbar('comer_cupcake', 'EATING Chicken Strips...', 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('bailey-chickfilajob:client:EatCoolWrap', function() -- Eat Cupcake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"eat"})
    QBCore.Functions.Progressbar('comer_cupcake', 'EATING A Chicken Wrap...', 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('bailey-chickfilajob:client:DrinkCoke', function() -- Drink Milkshake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"cup"})
    QBCore.Functions.Progressbar('beber_milkshake', 'DRINKING A COKE...', 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('bailey-chickfilajob:client:DrinkDrPepper', function() -- Drink Milkshake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"cup"})
    QBCore.Functions.Progressbar('beber_milkshake', 'DRINKING A Dr Pepper...', 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('bailey-chickfilajob:client:DrinkSweetTea', function() -- Drink Milkshake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"cup"})
    QBCore.Functions.Progressbar('beber_milkshake', 'DRINKING A SWEET TEA...', 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('bailey-chickfilajob:client:DrinkLemonade', function() -- Drink Milkshake
    food = math.random(40, 70)
    TriggerEvent('animations:client:EmoteCommandStart', {"cup"})
    QBCore.Functions.Progressbar('beber_milkshake', 'DRINKING A LEMONADE...', 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
