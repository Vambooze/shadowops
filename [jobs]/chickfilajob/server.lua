...
QBCore.Functions.CreateUseableItem("chickensandwich", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:EatChickenSandwich', source)
        Player.Functions.RemoveItem('chickensandwich', 1)
    end
end)

QBCore.Functions.CreateUseableItem("deluxsandwich", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:EatDeluxeChickenSandwich', source)
        Player.Functions.RemoveItem('deluxsandwich', 1)
    end
end)

QBCore.Functions.CreateUseableItem("spicychickensandwich", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:EatSpicyChickenSandwich', source)
        Player.Functions.RemoveItem('spicychickensandwich', 1)
    end
end)

QBCore.Functions.CreateUseableItem("spicydeluxechickensandwhich", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:EatDeluxeSpicyChickenSandwich', source)
        Player.Functions.RemoveItem('spicydeluxechickensandwhich', 1)
    end
end)

QBCore.Functions.CreateUseableItem("grilledchickensandwhich", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:EatGrilledChickenSandwich', source)
        Player.Functions.RemoveItem('grilledchickensandwhich', 1)
    end
end)

QBCore.Functions.CreateUseableItem("chick-n-strips", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:EatChickenStrips', source)
        Player.Functions.RemoveItem('chick-n-strips', 1)
    end
end)

QBCore.Functions.CreateUseableItem("coolwrap", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:EatCoolWrap', source)
        Player.Functions.RemoveItem('coolwrap', 1)
    end
end)
...
QBCore.Functions.CreateUseableItem("cocacola", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:DrinkCoke', source)
...
QBCore.Functions.CreateUseableItem("drpepper", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:DrinkDrPepper', source)
        Player.Functions.RemoveItem('drpepper', 1)
    end
end)

QBCore.Functions.CreateUseableItem("sweettea", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:DrinkSweetTea', source)
        Player.Functions.RemoveItem('sweettea', 1)
    end
end)
...
QBCore.Functions.CreateUseableItem("lemonade", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
        TriggerClientEvent('bailey-chickfilajob:client:DrinkLemonade', source)
        Player.Functions.RemoveItem('lemonade', 1)
    end
end)
