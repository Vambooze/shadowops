...
Config.contratos = {
	...
	['preco_por_km_min'] = 1900,				-- Minimum price per kilometer of the contract
	['preco_por_km_max'] = 2300,				-- Maximum price per kilometer of the contract
	['multiplicador_frete'] = 1.5,				-- Multiplier applied when generating FREIGHT loads
