...
-- General Configs --
Config.RenewedPhone = false              -- Enable if using Renewed-Phone / Uses qb-management if false
Config.PoliceJobs = { 'bcso' }        -- Set to the name of your police job(s)
Config.Fuel = 'ps-fuel'                -- Set to the name of your fuel script
...
-- Boss Menu Configs --
Config.BossMenus = {
    { label = 'PD Management', job = 'bcso', rank = 7, cert = 'none', coords = vec3(461.42, -986.25, 30.73), radius = 0.4 },
    { label = 'PD Management', job = 'bcso', rank = 6, cert = 'none', coords = vec3(447.05, -974.0, 30.5), radius = 0.4 }
}
...
sharedItems = exports.qb_inventory:Items()
