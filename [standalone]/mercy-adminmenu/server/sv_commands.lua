Mercy = exports['qb-core']:GetCoreObject()

-- [ Code ] --

-- [ Commands ] --

Mercy.Commands.Add('login', 'Login', {}, false, function(source)
    TriggerClientEvent('QBCore:Client:OnPlayerLoaded', -1)
end, 'god')

Mercy.Commands.Add(Config.Commands['MenuOpen'], Lang:t("info.keymapping_desc"), {}, false, function(source)
    TriggerClientEvent('mc-admin/client/try-open-menu', source, false)
end, 'admin')

Mercy.Commands.Add(Config.Commands['MenuDebug'], Lang:t("info.menu_debug"), {}, false, function(source)
    TriggerClientEvent('mc-admin/client/toggle-debug', source, false)
end, 'god')

Mercy.Commands.Add(Config.Commands['MenuReset'], Lang:t("info.reset_data"), {}, false, function(source)
    TriggerClientEvent('mc-admin/client/reset-menu', -1, false)
end, 'god')

Mercy.Commands.Add(Config.Commands['MenuPerms'], Lang:t("info.menu_perms"), {{name = "action", help = Lang:t('info.perm_action')}, {name = "commandid", help = Lang:t('info.commandid')}, {name = "group", help = Lang:t('info.rankid')}}, false, function(source, args)
...
Mercy.Commands.Add(Config.Commands['ReportNew'], Lang:t("info.send_report"), {{name = "message", help = Lang:t('info.message')}}, false, function(source, args)
...
Mercy.Commands.Add(Config.Commands['ReportChat'], Lang:t("info.reply_report"), {{name = "message", help = Lang:t('info.message')}}, false, function(source, args)
    local Message = table.concat(args, ' ')
    if Message ~= nil then
...
Mercy.Commands.Add(Config.Commands['ReportClose'], Lang:t("info.close_report"), {}, false, function(source, args)
