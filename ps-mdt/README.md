...
* [origen_inventory](https://github.com/qbcore-framework/origen_inventory) follow instructions below. 
...
```lua
        elseif QBCore.Shared.SplitStr(shopType, "_")[1] == "Itemshop" then
            if Player.Functions.RemoveMoney("cash", price, "itemshop-bought-item") then
                ...
                local imageurl = ("https://cfx-nui-origen_inventory/html/images/%s.png"):format(itemData.name)
