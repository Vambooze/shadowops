...
Config.Fire = {
    ...
    spawner = { -- Requires the use of the built-in dispatch system
        ...
        interval = 400000, -- Random fire spawn interval (set to nil or false if you don't want to spawn random fires) in ms
...
Config.Dispatch = {
    ...
    playSound = true,
    enableESX = "firefighter" -- Set to a ESX job / jobs you want to be automatically subscribed to dispatch; Set to nil or false if you don't want to use this
}