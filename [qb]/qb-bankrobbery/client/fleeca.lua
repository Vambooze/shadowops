...
exports['qb-target']:AddBoxZone("fleeca1", vector3(-365.34, -71.94, 45.66), 1.5, 1.5, {
	name = "fleeca1",
	heading = 11.0,
	debugPoly = false,
	minZ = 45.50,
...
exports['qb-target']:AddBoxZone("fleeca2", vector3(135.45, -1046.77, 29.33), 1.5, 1.5, {
	name = "fleeca2",
	heading = 11.0,
	debugPoly = false,
	minZ = 29.29,
...
exports['qb-target']:AddBoxZone("fleeca3", vector3(-1216.88, -332.94, 42.12), 1.5, 1.5, {
	name = "fleeca3",
	heading = 11.0,
	debugPoly = false,
	minZ = 42.00,
...
exports['qb-target']:AddBoxZone("fleeca4", vector3(320.15, -315.72, 51.17), 1.5, 1.5, {
	name = "fleeca4",
	heading = 11.0,
	debugPoly = false,
	minZ = 51.00,
...
exports['qb-target']:AddBoxZone("fleeca5", vector3(1157.78, 2708.92, 37.98), 1.5, 1.5, {
	name = "fleeca5",
	heading = 11.0,
	debugPoly = false,
	minZ = 37.78,
...
RegisterNetEvent('bank:UseThermite', function()
 QBCore.Functions.TriggerCallback('qb-bankrobbery:server:isRobberyActive', function(isBusy)
        if not isBusy then
            if CurrentCops >= Config.MinimumFleecaPolice then
                    ...
                    local hasItem = Config.HasItem({"thermite"})
                    if hasItem then
                    ...
                    if hasItem then
                        ...
                        QBCore.Functions.Progressbar("hack_gate", Lang:t("general.connecting_hacking_device"), math.random(5000, 10000), false, true, {
                            ...
                            exports['ps-ui']:VarHack(function(success)
                             ...
                             end, 4, 5) -- Number of Blocks, Time (seconds)
