...
QBShared.Jobs = {
	...
	ambulance = {
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = 'Firefighter', payment = 50 },
			['1'] = { name = 'Sr.Firefighter', payment = 50 },
			['2'] = { name = 'EMT A', payment = 75 },
			['3'] = { name = 'EMT B', payment = 100 },
			['4'] = { name = 'Fire Marshall', payment = 125 },
			['5'] = { name = 'Lieutenant',  payment = 150 },
			['6'] = { name = 'Assistant Chief', isboss = true, payment = 150 },
			['7'] = { name = 'Chief', isboss = true, payment = 150 },
		},
	},
	realestate = {
		label = 'Real Estate',
