...
RegisterCommand('idku', function()
    if showJobs then
        SendNUIMessage({type = 'EnableWatermarkJob', value = false})
        SendNUIMessage({type = 'EnableWatermarkId', value = false})
        showJobs = false
    else
        SendNUIMessage({type = 'EnableWatermarkJob', value = true})
        SendNUIMessage({type = 'EnableWatermarkId', value = true})
        showJobs = true
    end
end)
...
RegisterNetEvent('PMA_StatusRange')
AddEventHandler('PMA_StatusRange', function(mode) 
    SendNUIMessage({ type="set_status",       statustype = "mic_level", value = mode})
