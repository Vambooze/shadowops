...
Config.StressChance = 0.01         -- Default: 10% -- Percentage Stress Chance When Shooting (0-1)
...
Config.MinimumStress = 90         -- Minimum Stress Level For Screen Shaking
...
Config.Fuel = 'ps-fuel'        -- Fuel Script for getfuel and setfuel exports
