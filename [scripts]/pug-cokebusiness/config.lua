...
Config.InputScript = 'qb-input' -- (ox_lib) (ps-ui) (qb-input) Make this whatever input script that you use.
Config.Menu = 'qb-menu' -- (ox_lib, ps-ui, qb-menu) if you have change the resource name of qb-menu you can use there here as well
...
----------
Config.FuelScript = "ps-fuel" -- (ps-fuel) (LegacyFuel) (false) Set this to your fuel script name, if you do not have one set to false
...
----------
----------
Config.DrugPlaneDepositCurrency = "bank" -- Currency that is used for drug plane deposit
Config.DrugPlaneDeposit = 1000 -- $ How much the deposit for the drug plane cost
----------
Config.Currency = "bank" -- (money, bank, cash) what currency the player needs to purchase a laboratory
Config.CokeLabCost = 10000 -- $ How much the coke lab cost to purchase
----------
Config.DropOffBoxWorthEachMin = 125 -- $ How much dropping off each box is worth as a money bonus at the end of the drug run minimum
...
----------
Config.BoxesToGrabMin = 2-- Minimum boxes a player has to load onto the Drug plake
...
Config.TimeDrugsTakeToProcess = 10 -- (in minutes) Starting time it takes for Config.AmountOfDrugsToProcess to process. This gets faster and faster the higher upgrades the player unlocks. This runs while the player is loaded in and owns a coke lab.
...
----------
Config.TimePercentIncreaseUpgrade1 = 0.15 -- % faster the Config.TimeDrugsTakeToProcess will be when the player has upgraded there coke lab 1 time (default is 8.5 minutes)
Config.TimePercentIncreaseUpgrade2 = 0.20 -- % faster the Config.TimeDrugsTakeToProcess will be when the player has upgraded there coke lab 2 times (default is 8 minutes)
Config.TimePercentIncreaseUpgrade3 = 0.30 -- % faster the Config.TimeDrugsTakeToProcess will be when the player has upgraded there coke lab 3 times (default is 7 minutes)
----------
...
----------
Config.CokeBrickToSuppliesTanslation = {Min = 8, Max = 17} -- How much coke each coke brick turns into when you store it in your coke lab for the workers to break down into sellable coke.
----------
Config.MaxMembers = 2 -- The maximum amount of members that can own a coke lab together. (i would keep this low because the more members online the faster product is made)
Config.MaxPlaneRunsAtOne = 3 -- The max amount of coke plane runs the player can choose to do back to back to back.
----------
...
----------
Config.UpgradeCokeLabCost = 5500 -- $ cost to upgrade your coke lab workers (this is multiplied buy one more then the amount of times you have upgraded already when upgrading - starts at 0 upgrades so first upgrade will cost whatever Config.UpgradeCokeLabCost is)
Config.UpgradeCokeLabMembersCost = 2500 -- $ cost to upgrade your coke lab Members capacity. (this is multiplied buy the current members capacity number)
Config.KickMemberPrice = 5000 -- Cost of kicking a member (to prevent members being constantly swapped out and abused)
----------
...
Config.TimeItTakesToShutDownCokeLab = 4 -- Time in minutes it takes to shut down a coke lab as an officer (when a player with the police job enters a coke lab using there password they will have the option to shut the lab down forever on the laptop).
----------
